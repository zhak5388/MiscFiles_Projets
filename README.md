...
+ Implémentation de la prise majoritaire. La prise majoritaire impose de jouer la pièce qui permet de prendre le nombre maximal de prises. Par exemple, entre une dame qui permet de prendre 2 pièces et un pion permettant de raffler 4 pièces adverses, le joueur doit jouer le pion. (Voir méthode [cheminDesPrises](https://github.com/zhak5388/BUT_JeuDeDames/blob/main/src/PriseMajoritaireMethodes.java))
+ Pour la majorité des méthodes, un jeu de test unitaire a été élaboré
+ Élaboration d'un déroulé de test
